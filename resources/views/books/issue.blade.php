<div id="issue-{{ $issue->id }}">
                    ...
                    @case('issues')
                        ...
                        <div class="col-6 text-center" style="display:{{ !$issue->readed ? 'block' : 'none' }}"
                            ...
                            <button class="btn btn-primary btn-fab btn-fab-mini btn-link" title="Marcar como lido"
                                onclick="readed({{ $issue->id }}, {{ $issue->title_id }}, 'issue-{{ $issue->id }}', '{{ URL::to('title/books/' . $issue->title_id . '/next') }}')">
    ...
    <div class="text-center">
        <a
            href="{{ $result == 'titles' ? URL::to('title/books/' . $issue->id) : URL::to('issue/books/' . $issue->id) }}">
